        ...
        >
          ...
          >
            ...
            <Link
              ...
              className="inline-flex min-h-12 w-full min-w-45 items-center justify-center rounded-full bg-[#141b2b] px-6 py-2 text-[15px] font-semibold text-white transition-all duration-300 ease-out min-[500px]:w-auto lg:w-50 hover:bg-white hover:text-[#141B2A] hover:border-[#141B2A] hover:border lg:hover:w-98.75"
            >
              {t("Home.heroDiscover")}
            </Link>
          </div>

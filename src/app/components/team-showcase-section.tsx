    ...
    >
      ...
      >
        ...
        >
          ...
          <a
            href="#contact"
            className={`inline-flex h-12.5 w-54 items-center justify-center gap-2.5 rounded-3xl bg-[#086EA8] px-6 py-2 text-[18px] font-normal leading-8.5 text-white transition-all duration-300 ease-out hover:bg-white hover:text-[#141B2A] hover:border-[#141B2A] hover:border lg:hover:w-98.75 ${
